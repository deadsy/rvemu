...
var ISArv32i = ISAModule{
	...
	defn: []insDefn{
		...
		{"imm[20|10:1|11|19:12] rd 1101111 JAL", decodeTypeJ, daNone},
		{"imm[11:0] rs1 000 rd 1100111 JALR", decodeTypeI, daTypeIa},
		{"imm[12|10:5] rs2 rs1 000 imm[4:1|11] 1100011 BEQ", decodeTypeB, daNone},
		{"imm[12|10:5] rs2 rs1 001 imm[4:1|11] 1100011 BNE", decodeTypeB, daNone},
		{"imm[12|10:5] rs2 rs1 100 imm[4:1|11] 1100011 BLT", decodeTypeB, daNone},
		{"imm[12|10:5] rs2 rs1 101 imm[4:1|11] 1100011 BGE", decodeTypeB, daNone},
		{"imm[12|10:5] rs2 rs1 110 imm[4:1|11] 1100011 BLTU", decodeTypeB, daNone},
		{"imm[12|10:5] rs2 rs1 111 imm[4:1|11] 1100011 BGEU", decodeTypeB, daNone},
		...
		{"imm[11:0] rs1 100 rd 0010011 XORI", decodeTypeI, daTypeIa},
		{"imm[11:0] rs1 110 rd 0010011 ORI", decodeTypeI, daTypeIa},
		{"imm[11:0] rs1 111 rd 0010011 ANDI", decodeTypeI, daTypeIa},
		{"0000000 shamt5 rs1 001 rd 0010011 SLLI", decodeTypeI, daNone},
		{"0000000 shamt5 rs1 101 rd 0010011 SRLI", decodeTypeI, daNone},
		{"0100000 shamt5 rs1 101 rd 0010011 SRAI", decodeTypeI, daNone},
...
var ISArv32f = ISAModule{
	...
	defn: []insDefn{
		...
		{"imm[11:5] rs2 rs1 010 imm[4:0] 0100111 FSW", decodeTypeS, daTypeSa},
...
var ISArv32d = ISAModule{
	name: "rv32d",
	defn: []insDefn{
		{"imm[11:0] rs1 011 rd 0000111 FLD", decodeTypeI, daTypeIa},
		{"imm[11:5] rs2 rs1 011 imm[4:0] 0100111 FSD", decodeTypeS, daTypeSa},
		{"rs3 01 rs2 rs1 rm rd 1000011 FMADD.D", decodeTypeR4, daNone},
		{"rs3 01 rs2 rs1 rm rd 1000111 FMSUB.D", decodeTypeR4, daNone},
		{"rs3 01 rs2 rs1 rm rd 1001011 FNMSUB.D", decodeTypeR4, daNone},
		{"rs3 01 rs2 rs1 rm rd 1001111 FNMADD.D", decodeTypeR4, daNone},

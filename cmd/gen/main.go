...
func addModule(isa *cpu.ISA, ins []string, mod cpu.ISAModule) error {
	for i := range ins {
		err := isa.Add(ins[i], mod)
		if err != nil {
			return err
		}
	}
...
func main() {
	...
	addModule(isa, rv32i, cpu.ISArv32i)
	addModule(isa, rv32m, cpu.ISArv32m)
	addModule(isa, rv32a, cpu.ISArv32a)
